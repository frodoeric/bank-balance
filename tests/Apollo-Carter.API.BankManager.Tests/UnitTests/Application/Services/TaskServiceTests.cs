...
//    {
//        private readonly Mock<IApolloDataRepository> _mockTaskRepository = new Mock<IApolloDataRepository>();
...
//        private readonly ApolloDataProfile _mockTaskViewModelMapper = new ApolloDataViewModelProfile(_mockIHttpContextAccessor.Object);
...
//            _mockIMediator.Setup(x => x.SendAsync<Account>(It.IsAny<CreateNewApolloCommand>(), null))
...
//            _mockIMediator.Verify(x => x.SendAsync<Account>(It.IsAny<CreateNewApolloCommand>(), null), Times.Once);
//        }
//    }
//}
